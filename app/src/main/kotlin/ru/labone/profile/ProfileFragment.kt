...
import ru.labone.formatDate
import ru.labone.navigateBack
import ru.labone.showAlert
import ru.labone.showDatePicker
...
class ProfileFragment : DialogFragment(R.layout.fragment_profile), MavericksView {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.effects.collect(lifecycleScope) { profileEffects ->
            when (profileEffects) {
                is RenderPhoto -> renderPhoto(profileEffects.photoUri?.toUri())
            }
        }
    }
    ...
    private fun renderGender(gender: Gender?) {
        ...
        val inactiveColor = color(R.color.colorPrimaryLight)
        val activeBorder = colorSL(R.color.colorPrimaryLight)
